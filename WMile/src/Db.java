...
public class Db{
 ...
 public static String upis(String link, String user, String pass, int bodovi,int level) throws Exception{
    ...
    printout.writeBytes ("user="+user+"&pass="+pass+"&bodovi="+bodovi+"&level="+level);
